...
const profile={id:'30000000-0000-4000-8000-000000000001',username:'alice_teste',name:'Alice Teste',bio:'Mais uma partida e a gente vai.\nBeach tennis, encontros e boas histórias na areia.',city:'São Paulo',neighborhood:'Vila Madalena',available:true,isDemo:true,onboardingCompleted:true,avatar:'/icon.svg',avatarPath:'30000000-0000-4000-8000-000000000001/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa.webp',sports:[{sport:sports[0],level:'Intermediário',isPrimary:true}]};
