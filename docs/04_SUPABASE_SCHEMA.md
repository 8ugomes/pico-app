...
> Menções · 14/09/2026: `20260914120000_community_post_mentions.sql` acrescenta `post_id` e novos tipos à caixa de notificações, índice único por post/comunidade/destinatário, busca autorizada de participantes e publicação idempotente com menções. RLS e leitura atual de post/destino/grupo continuam exigidos. Aplicada no desenvolvimento e no principal; [contrato e recibo](COMMUNITY_MENTIONS.md).
