...
> 14/09/2026: menções individuais e `@todos` em publicações de comunidades compartilham esta caixa, com link direto ao post e leitura sujeita à audiência atual. [Contrato](COMMUNITY_MENTIONS.md).
