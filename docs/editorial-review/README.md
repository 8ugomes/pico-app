...
A regra permanente está em Deslopify, AGENTS, skill e guia de revisão, manual, contexto institucional e design system. As tarefas de fluxo/arenas e estabilidade foram avisadas; o checkout main foi liberado pelo responsável da publicação anterior. A tarefa da landing concluiu sua revisão no commit e2f8ec6, na branch codex/beta-security: metadados, textos de apoio, legendas, catálogos, SVGs/PNGs e ZIPs sincronizados. Lint/typecheck/build da landing e smoke mobile/desktop aprovados por essa tarefa. Materiais já salvos em Downloads atualizados; nenhum deploy da landing nesta rodada e nenhuma mistura de suas alterações anteriores com a main do app.

## Verificação

- Lint, typecheck e build conectado aprovados. Após corrigir a expectativa de ordem da CI, a suíte local completa passou com 133 testes.
...
A primeira CI encontrou uma expectativa antiga de posição fixa no catálogo de comunidades. O nome novo muda a ordem alfabética; o teste de custódia agora localiza o ID da comunidade privada, mantendo as asserções de leitura e autoridade. Nenhuma permissão foi alterada para satisfazer o teste.
