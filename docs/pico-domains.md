...
| Notificações | [Contrato](NOTIFICATIONS.md), `NotificationsProvider`, `NotificationsView`, `NotificationLink`, `/api/notifications` | Avisos por destinatário após entrada ativa; participação atual, bloqueio e admissão; leitura explícita, demo vazio e nenhuma notificação do sistema. |
