...
export function AppShell({ children, environment = 'demo' }: { children: ReactNode; environment?: 'demo' | 'configured' | 'invalid' }) {
  ...
  return <div className="social-app">
    ...
    <div className="app-center">
      ...
      {connected ? <div className="demo-banner read-mode-banner"><span className="demo-indicator" />Seu Pico <span>· conta, arenas e presença</span></div> : <div className="demo-banner"><span className="demo-indicator" />Demonstração <span>· pessoas fictícias, ações nesta sessão</span></div>}
