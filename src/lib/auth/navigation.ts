...
export function safeNext(value:string|null){return value&&/^\/(?:arenas|comunidades|publicacoes|perfil|jogos|notificacoes)(?:\/[a-zA-Z0-9_-]+){0,2}$/.test(value)?value:'/perfil'}
